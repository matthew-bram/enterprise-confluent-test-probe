...
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 72-108)
...
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 110-139)
...
**Conversion:** `RestModelConversions.toCore(req)` → `(UUID, String, Option[String])`
**Actor Communication:** `ServiceInterfaceFunctions.startTest(testId, bucket, testType)`
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 141-184)
...
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 186-205)
...
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 207-228)
...
**File:** `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (lines 230-250)
...
- `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/models/rest/RestModels.scala` (DTO schemas)
- `/test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/models/rest/RestModelConversions.scala` (80 lines, anti-corruption layer)

**Tests:**
- `/test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest/RestRoutesHealthCheckSpec.scala` (280 lines, 10 tests)
- `/test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest/RestRoutesErrorHandlingSpec.scala` (704 lines, 27 tests)
- `/test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest/RestValidationSpec.scala` (247 lines, 19 tests)
