...
**1. Create Test File:**
```scala
// test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest/RestRoutesNewEndpointSpec.scala
...
```bash
# Run new tests only
mvn test -pl test-probe-interfaces -Dtest=RestRoutesNewEndpointSpec

# Run all REST tests
mvn test -pl test-probe-interfaces -Dtest=RestRoutes*
```
...
**Step Definitions:**
```scala
// test-probe-boot/src/test/scala/io/distia/probe/boot/steps/RestApiSteps.scala
...
- `/test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest/RestErrorResponseSpec.scala` (360 lines, 18 tests)
