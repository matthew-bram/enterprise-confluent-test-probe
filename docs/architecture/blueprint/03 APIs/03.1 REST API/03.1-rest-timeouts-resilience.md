...
**Implementation:** `/test-probe-interfaces/src/main/scala/com/company/probe/interfaces/config/InterfacesConfig.scala` (124 lines)
...
- `/test-probe-interfaces/src/main/scala/com/company/probe/interfaces/config/InterfacesConfig.scala` (124 lines)
- `/test-probe-interfaces/src/main/resources/reference.conf` (84 lines)

**Tests:**
- `/test-probe-interfaces/src/test/scala/com/company/probe/interfaces/config/InterfacesConfigSpec.scala` (timeout validation tests)
