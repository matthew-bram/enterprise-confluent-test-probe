...
2. Maven: All current tests passing 
3. Java 21+ installed 
4. Scala 3.3.6 available
...
**File**: `test-probe-core/src/main/scala/io/distia/probe/core/builder/ServiceInterfaceFunctions.scala`
...
```bash
mkdir -p test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/config
mkdir -p test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/models/rest
mkdir -p test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/builder/modules
mkdir -p test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest
mkdir -p test-probe-interfaces/src/main/resources
mkdir -p test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/builder/modules
mkdir -p test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/rest
```

#### Task 2.2: Create InterfacesConfig

**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/config/InterfacesConfig.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/models/rest/RestApiModels.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/models/rest/RestModelConversions.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/builder/modules/DefaultRestInterface.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestServer.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/RestRoutes.scala` (NEW)
...
**File**: `test-probe-interfaces/src/main/scala/io/distia/probe/interfaces/rest/JsonFormats.scala` (NEW)
...
**Location**: `test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/bdd/`
...
**File**: `test-probe-interfaces/src/test/scala/io/distia/probe/interfaces/ComponentTestRunner.scala`
