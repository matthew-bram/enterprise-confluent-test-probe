...
```scala
// In test-probe-core/src/main/scala/com/company/probe/core/builder/modules/package.scala
...
```scala
// In test-probe-services/src/main/scala/com/company/probe/services/builder/modules/LocalBlockStorageService.scala
...
```scala
// In test-probe-core/src/main/scala/com/company/probe/core/builder/StorageServiceFunctions.scala
...
```scala
// In test-probe-core/src/main/scala/com/company/probe/core/models/ServiceFunctionsContext.scala
...
```scala
// In test-probe-core/src/main/scala/com/company/probe/core/actors/BlockStorageActor.scala
def apply(
  testId: UUID,
...
```scala
// In test-probe-core/src/main/scala/com/company/probe/core/builder/modules/DefaultActorSystem.scala
override def initialize(config: ServiceConfig, context: BuilderContext): Unit = {
...
**File**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/LocalBlockStorageService.scala` (240 lines)
...
**File**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/AwsBlockStorageService.scala` (330 lines)
...
**File**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/AzureBlockStorageService.scala` (330 lines)
...
**File**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/GcpBlockStorageService.scala` (340 lines)
...
**File**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/LocalVaultService.scala`
...
**Location**: `test-probe-core/src/test/scala/com/company/probe/core/helpers/ServiceFunctionsTestHelper.scala`
...
- Service Implementations: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/*Service.scala`
