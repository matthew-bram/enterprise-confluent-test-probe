...
**Location**: `test-probe-services/src/main/scala/com/company/probe/services/vault/RequestBodyBuilder.scala`
...
**Location**: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/AzureVaultService.scala` (lines 118-162)
...
**Services Module**:
```
test-probe-services/src/main/scala/com/company/probe/services/
├── vault/
...
**Common Module**:
```
test-probe-common/src/main/scala/com/company/probe/common/
├── rosetta/
...
- RequestBodyBuilder: `test-probe-services/src/main/scala/com/company/probe/services/vault/RequestBodyBuilder.scala` (lines 1-150)
- AzureVaultService: `test-probe-services/src/main/scala/com/company/probe/services/builder/modules/AzureVaultService.scala` (lines 118-162)
